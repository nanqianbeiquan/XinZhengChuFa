...
class html_shandong(object):
    ...
    def get_filename_list_1(self):
        """
        返回山东省,filename为htm的列表
        1为非正常户
        """
        self.mysql_conn()
        sql_1 = "SELECT * FROM taxplayer_filename where province='山东省' AND title like '%非正常户%' \
    ...
    def get_filename_list_2(self):
        ...
        """
        self.mysql_conn()
        sql_2 = "SELECT * FROM taxplayer_filename where province='山东省' AND title not like '%非正常户%' \
        AND filename LIKE '%htm%'"
    ...
    def get_filename_path_list_1(self):
        '''
        返回返回山东省,filename为htm的path 列表
        1为非正常户
        '''
        filename_path_list_1 = []
        fbrq_list_1 = []
        filename_list_1 = html_shandong().get_filename_list_1()
        for i in filename_list_1:
            # print i[4]
            filename_path = r'D:\All_files\ShanDong\savehtml' + '\\' + i[4]
    ...
    def get_filename_path_list_2(self):
        ...
        filename_list_2 = html_shandong().get_filename_list_2()
    ...
    def get_detail_1(self):
        ...
        filename_path_list_1 = html_shandong().get_filename_path_list_1()[0]
        fbrq_list_1 = html_shandong().get_filename_path_list_1()[1]
        for i in range(len(filename_path_list_1)):
            ...
            try:
                ...
                tr_title = all_tr[0]
                fields = self.field
                match_fields = html_shandong().get_field_info(tr_title,fields)
                print match_fields
